...
echo'
	<div id="top_bar"><div class="frame">
		<div class="contenido">
			<span class="floatright">
				<strong>', $txt['date'], ':</strong> ',timeformat(time(),'%d/%m/%y - %H:%M %p'), '&nbsp;&nbsp;&nbsp;', $context['common_stats']['total_topics'], ' ', $txt['topics'], $txt['who_and'], $context['common_stats']['total_posts'], ' ', $txt['posts_made'], '
			</span>
			<div class="floatleft">
				<ul class="reset top_links">
	...
	echo '
			...
			<br class="clear" />
			<div class="buscador_ha">
				<form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
					<input type="text" name="search" value="', $txt['search'], '..." onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['search'], '...\';" class="texto_ha" />
					<input type="submit" name="submit" value="" class="submit_ha" />
...
function ha_copy()
{
	$HACOPY = 'Theme by <a href="https://smftricks.com/">SMF Tricks</a>';
